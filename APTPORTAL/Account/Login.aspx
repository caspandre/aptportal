<%@ Page Title="Accedi" Language="C#" MasterPageFile="~/Admin/Site.master" AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="APTPORTAL.Admin.Login" %>
        ...
        <LayoutTemplate>
            ...
            <div class="accountInfo">
                ...
                <p class="submitButton">
                    <asp:Button ID="LoginButton" runat="server" CommandName="Login" Text="Accedi" ValidationGroup="LoginUserValidationGroup" OnClick="check_login"/>
                </p>
            </div>
        </LayoutTemplate>
    </asp:Login>
